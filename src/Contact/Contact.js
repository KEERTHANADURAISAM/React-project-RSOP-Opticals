...
import ph1 from "./paper-plane.png";
    ...
    <Base>
      <form onSubmit={handleSubmit}>
        <div className="contact-main-container">
          ...
          <p className="contact-sub-content">
            Lorem ipsum dolor sit amet consectetur adipisicing elit.
            <br></br>Beatae,corruptieos quod aperiam.Lorem ipsum dolor sit amet
            consectetur adipisicing elit.<br></br>Beatae,corruptieos quod
            aperiam
          </p>
          <div className="contact-Tests">
            <div className="contact-img-div">
              ...
              <p className="contact-content-text">
                ...
                elit. Beatae,corruptieos quod <br></br>aperiam.Lorem ipsum dolor{" "}
                <br></br>
                consectetur adipisicing elit.<br></br>Beatae,corruptieos quod
                aperiam
              </p>
        ...
        <div className="get-msg-main-div">
          <div className="get-inputbox">
            ...
            <p>
              Lorem ipsum dolor sit amet consectetur adipisicing elit.
              <br></br>Beatae,corruptieos quod aperiam.Lorem ipsum dolor sit
              amet consectetur adipisicing elit.<br></br>Beatae,corruptieos quod
              aperiam
            </p>
            <input
              className="input-box"
          ...
          <div className="subgrid-contact">
            <div className="media-details">
              ...
              <p>9078564534</p>
              <div className="media">
                <img src={ph1} alt="" className="media-icons" />
                <p>Email-address</p>
